...
module MiniAgent
  ...
  class ToolCallRunner
    ...
    # окна уже забронировал ответ модели (Config::WINDOW_SHARE), от второй
